 ...
 * Point light helper
 */
const pointLightHelper0 = new THREE.Mesh(
  new THREE.IcosahedronGeometry(0.1, 2),
  new THREE.MeshBasicMaterial()
)
pointLightHelper0.material.color.setRGB(1.0, 0.1, 0.1)
pointLightHelper0.position.set(0.0, 2.0, 0.0)
...
pointLightHelper1.position.set(2.0, 2.0, 2.0)
